...
function BotVeillePyWorkflow() {
  const { language } = useLanguage()
  const navigate = useNavigate()
  const [scrollProgress, setScrollProgress] = useState(0)
  const [titleOpacity, setTitleOpacity] = useState(1)

  const workflow = workflows.find(w => w.slug === 'bot-veille-py')
  ...
  return (
    <div className="relative font-sans text-white bg-black">
      ...
      <div className="fixed top-0 left-0 w-full h-full z-0 overflow-hidden bg-black">
        <TitleOpener title="BOTVEILLELPY" titleOpacity={titleOpacity} />
        {scrollProgress < 0.5 && (
...
export default BotVeillePyWorkflow
